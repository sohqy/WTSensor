...
def WriteData(CurrentReading):
    Red.on()
    File = open('/home/pi/Sep_LevelSensorData.csv', 'a')     # Add name of tank here.
...
# ----- Set up storage file
File = open('/home/pi/Sep_LevelSensorData.csv', 'a')
File.write('Datetime,Water Level\n')
File.close()

#now = time.localtime()
time.sleep((5 - time.localtime().tm_min%5) * 60 - time.localtime().tm_sec)
